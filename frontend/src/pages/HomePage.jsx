    ...
    return (
        ...
        <div className = "container mx-auto px-16 relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-5">
                <div className="block rounded-xl drop-shadow-red-900 bg-gray-300 py-20 drop-shadow-lg px-5">
                ...
                <div className="block rounded-xl drop-shadow-red-900 bg-gray-300 py-20 drop-shadow-lg px-5">
                    ...
                    <p className="text-center text-black leading-loose">
                        Gym tracking is proven to be highly effective for building muscle and encouraging progressive overload. Begin tracking today to ensure your muscles are consistently challenged, and your goals are consistently hit. 
                    </p>
                </div>
            </div>
        </div>
